...
CREATE INDEX IF NOT EXISTS idx_tournament_results_team_id ON public.tournament_results(team_id);
...
COMMENT ON TABLE public.tournament_results IS 'Stores tournament results, previously named event_results';
